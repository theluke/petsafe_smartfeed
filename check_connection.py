...
if __name__ == "__main__":
    ...
    try:
        if args.dry_run:
            ...
            logger.debug(f"Loaded raw feed messages: {json.dumps(feed_messages, indent=2)}")
            
            filtered_messages = filter_feed_messages(feed_messages)
            if filtered_messages:
                print("        Filtered feeding history (last 7 days):")
